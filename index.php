...
<body class="bg-gray-100">
     ...
     <nav class="bg-white shadow-md py-4 px-6 flex items-center justify-between">
        ...
        <div class="flex gap-4">
            ...
            if (isset($_SESSION['username'])) {
                ...
                echo '<a href="./Authentification/register.php" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">Sign up</a>';
            }
            ?>
        </div>
    </nav>
    ...
    <!-------------------------- Hero--------------------->
    <div class="relative bg-cover bg-center h-[500px]" style="background-image: url('./img/hero4.jpg');">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-center text-center text-white gap-6">
            ...
            <a href="./Articles/create_article.php" class="px-6 py-3 text-white bg-violet-500 rounded-lg text-lg font-semibold hover:bg-violet-600">Create Article</a>
        </div>
    </div>
                ...
                <?php while ($row = $result->fetch_assoc())  : ?>
                    <div class="p-6 bg-white rounded-lg shadow-md">
                        ...
                        <?php endif; ?>                        
                            ...
                            ?>
                                    <div class="mb-2 p-2 border rounded-lg">
                                        ...
                                        <div class="flex gap-2 justify-end">
                                            ...
                                            <a href="./Comments/update_comment.php?idcomment=<?= $comment['idcomment'] ?>" class="p-2 text-blue-500 hover:text-blue-700">
                                                <i class="fa-solid fa-pen" style="color: #916dfd;"></i> 
                                            </a>
                                            
                                            <a href="./Comments/delete_comment.php?idcomment=<?= $comment['idcomment'] ?>" class="p-2 text-red-500 hover:text-red-700" onclick="return confirm('Are you sure you want to delete this comment?')">
                            ...
                            <!------------- add comment-------------->
                            <a href="./Comments/create_comment.php?idarticle=<?= $idarticle ?>" class="block mt-4 px-4 py-2 bg-violet-500 text-white text-center rounded-lg hover:bg-violet-600">Add Comment</a>

                            <div class="flex gap-4 justify-end">
                                <a href="./Articles/update_article.php?idarticle=<?= $row['idarticle'] ?>" class="p-2  text-blue ">
                                    <i class="fa-solid fa-pen-to-square" style="color: #916dfd;"></i>
                                </a>
                                <a href="./Articles/delete_article.php?idarticle=<?= $row['idarticle'] ?>" class="p-2 text-red " onclick="return confirm('Are you sure you want to delete this article?')">
                                    <i class="fa-solid fa-trash-can" style="color: #e92b2b;"></i>
                                </a>
